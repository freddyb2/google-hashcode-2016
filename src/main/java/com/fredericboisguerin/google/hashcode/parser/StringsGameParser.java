...
import com.fredericboisguerin.google.hashcode.model.input.Weight;
...
class StringsGameParser {
    ...
    private void addProductItemsToContainer(int quantity, ProductType productType,
            Consumer<ProductItem> productItemConsumer) {
