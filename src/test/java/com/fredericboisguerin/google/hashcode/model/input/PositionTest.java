...
public class PositionTest {
    ...
    @Test
    public void should_return_0_when_getRow_given_E() {
        int row = E.getRow();
    ...
    @Test
    public void should_return_0_when_getColumn_given_E() {
    ...
    @Test
    public void should_return_2_when_distance_between_A_and_B() {
    ...
    @Test
    public void should_return_2_when_distance_between_B_and_A() {
    ...
    @Test
    public void should_return_3_when_distance_between_A_and_C() {
    ...
    @Test
    public void should_return_2_when_distance_between_D_and_E() {
