...
public class ProductItemContainerTest {
    ...
    public void should_throw_IllegalStateException_when_unstore_on_empty_warehouse()
            throws Exception {
        productItemContainer.unload(PRODUCT_TYPE_A);
    }

    @Test(expected = IllegalStateException.class)
    public void should_throw_IllegalStateException_when_unstore_on_warehouse_without_product_of_required_type()
            throws Exception {
    ...
    @Test
    public void should_return_the_only_product_of_type_A_after_it_has_been_stored()
            throws Exception {
